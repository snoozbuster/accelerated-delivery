...
namespace Accelerated_Delivery_Win
{
        ...
        internal void GetMachineInputs(int machineNo, out Keys key, out Buttons button)
        {
            switch(machineNo)
            {
                case 1: key = Machine1Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine1Key;
                    break;
                case 2: key = Machine2Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine2Key;
                    break;
                case 3: key = Machine3Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine3Key;
                    break;
                case 4: key = Machine4Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine4Key;
                    break;
                case 5: key = Machine5Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine5Key;
                    break;
                case 6: key = Machine6Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine6Key;
                    break;
                case 7: key = Machine7Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine7Key;
                    break;
                case 8: key = Machine8Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine8Key;
                    break;
                case 9: key = Machine9Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine9Key;
                    break;
                case 10: key = Machine0Key;
                    button = Program.Game.Manager.CurrentSaveXboxOptions.Machine0Key;
                    break;
                default:
                    key = Keys.None;
                    button = (Buttons)(-1);
    ...
    public class XboxOptions
    {
        ...
        internal void Swap(Pointer<Buttons> variable, Buttons pressedKey)
        {
