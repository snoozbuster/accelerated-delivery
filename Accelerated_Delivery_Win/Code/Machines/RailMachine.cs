...
namespace Accelerated_Delivery_Win
{
    public class RailMachine : OperationalMachine
    {
        ...
        protected MachineSoundInstance railSlideSound;
        ...
        protected readonly bool soundWhenMoves;
        ...
        {
            if(railSlideSound != null && !railSlideSound.IsDisposed && railSlideSound.State == SoundState.Playing)
                railSlideSound.Stop(true);
        ...
        protected override void updateVelocities()
        {
            ...
            slideTime += GameManager.Space.TimeStepSettings.TimeStepDuration;
        }
