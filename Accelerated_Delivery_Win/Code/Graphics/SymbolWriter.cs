    ...
    public static class SymbolWriter
    {
        ...
        public static void WriteKeyboardIcon(Keys key, Vector2 pos, Vector2 origin, bool scaleDown)
        {
            ...
            if(but != KeyboardButtons1.KeyNotSupported)
            {
                ...
                if(!scaleDown)
                    Program.Game.SpriteBatch.Draw(keyboardTex, pos, temp, col, 0.0f, origin, 0.83f * Program.Game.TextureScaleFactor, SpriteEffects.None, 0);
                else if(scaleDown)
                    Program.Game.SpriteBatch.Draw(keyboardTex, pos, temp, col, 0.0f, origin, 0.444f * Program.Game.TextureScaleFactor, SpriteEffects.None, 0);
            }
        ...
        /// <summary>
        /// This function takes a Microsoft.Xna.Framework.Input.Keys and converts it to a
        ...
        public static void WriteXboxIcon(Buttons button, Vector2 pos, Vector2 origin, bool scaleDown)
        {
            ...
            Color col = new Color(255, 255, 255, alpha) * (alpha / 255f);
            if(!scaleDown)
                Program.Game.SpriteBatch.Draw(xboxTex, pos, temp, col, 0.0f, origin, 0.83f * Program.Game.TextureScaleFactor, SpriteEffects.None, 0);
            if(scaleDown)
                Program.Game.SpriteBatch.Draw(xboxTex, pos, temp, col, 0.0f, origin, 0.444f * Program.Game.TextureScaleFactor, SpriteEffects.None, 0);
        }

        /// <summary>
        /// This function takes a Microsoft.Xna.Framework.Input.Buttons and converts it to a
        ...
        static SymbolWriter()
        {
            ...
            keyboardTex = Program.Game.Content.Load<Texture2D>("Font/KeyboardFinal_reach");
            xboxTex = Program.Game.Content.Load<Texture2D>("Font/xboxbuttons_final");
        }
    }
}
