        ...
        internal void GetMachineInputs(int machineNo, out Keys key, out Buttons button)
        {
            switch(machineNo)
            {
                case 1: key = Machine1Key;
                    button = Input.XboxOptions.Machine1Key;
                    break;
                case 2: key = Machine2Key;
                    button = Input.XboxOptions.Machine2Key;
                    break;
                case 3: key = Machine3Key;
                    button = Input.XboxOptions.Machine3Key;
                    break;
                case 4: key = Machine4Key;
                    button = Input.XboxOptions.Machine4Key;
                    break;
                case 5: key = Machine5Key;
                    button = Input.XboxOptions.Machine5Key;
                    break;
                case 6: key = Machine6Key;
                    button = Input.XboxOptions.Machine6Key;
                    break;
                case 7: key = Machine7Key;
                    button = Input.XboxOptions.Machine7Key;
                    break;
                case 8: key = Machine8Key;
                    button = Input.XboxOptions.Machine8Key;
                    break;
                case 9: key = Machine9Key;
                    button = Input.XboxOptions.Machine9Key;
                    break;
                case 10: key = Machine0Key;
                    button = Input.XboxOptions.Machine0Key;
                    break;
                default:
                    key = Keys.None;
                    button = (Buttons)(-1);
