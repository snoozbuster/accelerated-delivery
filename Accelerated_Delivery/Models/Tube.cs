...
namespace Accelerated_Delivery_Win
{
    public class Tube : BaseModel, ISpaceObject
    {
        ...
        protected static Model tubeModel;
        ...
        public void BecomeKeybasedTube(int machineNo)
        {
            ...
            Input.WindowsOptions.GetMachineInputs(machineNo, out key, out button);
        }
        ...
        public override void Update(GameTime gameTime)
        {
            if(key != Keys.None)
            {
                if(Input.CheckMachineIsHeld(machineNo))
                    Rotating = true;
                else
                    Rotating = false;
            }
