...
namespace Accelerated_Delivery_Win
{
    public static class MediaSystem
    {
        ...
        /// </summary>
        public static bool PlayingVoiceActing { get { if(playingVoiceActing != null) return !(playingVoiceActing.State == SoundState.Paused || playingVoiceActing.State == SoundState.Stopped) && !Input.WindowsOptions.Muted; return false; } }
        /// <summary>
...
//#endif
        ...
        {
            //if(playingBGM != null && isActive && playingBGM.State != SoundState.Playing && !Input.WindowsOptions.Muted)
            //{
            ...
            if(!Input.WindowsOptions.Muted)
            {
                //volToReturnTo = Input.WindowsOptions.BGMVolume;
                //volToReturnToSFX = Input.WindowsOptions.SFXVolume;
                //engine.SetGlobalVariable("BGMVolume", maxBGMVolume);
                //engine.SetGlobalVariable("SFXVolume", maxMachineVolume);
...
#if WINDOWS
            if(Input.CheckKeyboardJustPressed(Input.WindowsOptions.MuteKey))
            {
                ToggleMute();
            }
#endif
        ...
        public static void PlayVoiceActing(int trackNo)
        {
            ...
            if(!Input.WindowsOptions.VoiceClips)
                return;
        ...
        {
            if(voiceActing != null)
                GameManager.Cutter.WriteToLog("MediaSystem", "Warning: Voice acting was reloaded.");
        ...
        public static void LoadSoundEffects(ContentManager content)
        {
            if(soundEffects != null)
                GameManager.Cutter.WriteToLog("MediaSystem", "Sound effects were reloaded.");

            string basePath = "Music/SFX/";
            soundEffects = new Dictionary<SFXOptions, SoundEffect>();
            soundEffects.Add(SFXOptions.Achievement, content.Load<SoundEffect>(basePath + "Achievement"));
            soundEffects.Add(SFXOptions.Box_Death, content.Load<SoundEffect>(basePath + "Box_Death"));
            soundEffects.Add(SFXOptions.Box_Success, content.Load<SoundEffect>(basePath + "Possible_Box_Success"));
            soundEffects.Add(SFXOptions.Button_Press, content.Load<SoundEffect>(basePath + "Button_Depress"));
            soundEffects.Add(SFXOptions.Button_Release, content.Load<SoundEffect>(basePath + "Button_Release"));
            soundEffects.Add(SFXOptions.Button_Rollover, content.Load<SoundEffect>(basePath + "Button_Roll_Over"));
            soundEffects.Add(SFXOptions.Explosion, content.Load<SoundEffect>(basePath + "Explosion"));
            soundEffects.Add(SFXOptions.Fail, content.Load<SoundEffect>(basePath + "Fail"));
            soundEffects.Add(SFXOptions.Laser, content.Load<SoundEffect>(basePath + "Laser"));
            soundEffects.Add(SFXOptions.Machine_Button_Press, content.Load<SoundEffect>(basePath + "button_depress_2"));
            soundEffects.Add(SFXOptions.Pause, content.Load<SoundEffect>(basePath + "Pause_Jingle"));
            soundEffects.Add(SFXOptions.Press_Start, content.Load<SoundEffect>(basePath + "Press_Start"));
            soundEffects.Add(SFXOptions.Result_Da, content.Load<SoundEffect>(basePath + "Possible_Result_Da"));
            soundEffects.Add(SFXOptions.Siren, content.Load<SoundEffect>(basePath + "Siren"));
            soundEffects.Add(SFXOptions.Win, content.Load<SoundEffect>(basePath + "Level_Win"));
            soundEffects.Add(SFXOptions.Startup, content.Load<SoundEffect>(basePath + "startup"));
        ...
        {
            if(bgmList != null)
                GameManager.Cutter.WriteToLog("MediaSystem", "BGM was reloaded.");
        ...
        {
            Input.WindowsOptions.Muted = !Input.WindowsOptions.Muted;
            //if(Input.WindowsOptions.Muted)
            //{
