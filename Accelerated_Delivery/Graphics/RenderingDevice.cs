...
namespace Accelerated_Delivery_Win
{
    ...
    public static class RenderingDevice
    {
        ...
        private static BoxCutter Cutter;
        ...
        public static void Add(Model m, Effect shader, Dictionary<string, object> objects, params Texture2D[] samplers)
        {
            try
            {
                ...
                {
                    Cutter.WriteToLog(d, "Warning: Add(m, shader, objects, samplers) was called with a null parameter. Ensure this is correct behavior.");
                    return;
                }
        ...
        public static void Add(VertexBuffer vertBuffer, Texture2D texture)
        {
            try
            {
                ...
                {
                    Cutter.WriteToLog(d, "Warning: Add(vertBuffer, texture) was called with a null parameter. Ensure this is correct behavior.");
                    return;
                }
        ...
        public static void Add(IDPSFParticleSystem system)
        {
            if(system == null)
            {
                Cutter.WriteToLog(d, "Warning: Add(system) was called with a null parameter. Ensure this is correct behavior.");
                return;
            }
        ...
        public static void SetShaderValues(Model m, string[] keys, object[] values)
        {
            ...
            {
                Cutter.WriteToLog(d, "Warning: SetShaderValues() was called with a null parameter. Ensure this is correct behavior.");
                return;
            }
