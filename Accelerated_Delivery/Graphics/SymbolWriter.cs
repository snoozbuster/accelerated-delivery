    ...
    public static class SymbolWriter
    {
        ...
        public static void WriteKeyboardIcon(Keys key, Vector2 pos, Vector2 origin, bool scaleDown)
        {
            ...
            if(but != KeyboardButtons1.KeyNotSupported)
            {
                ...
                if(!scaleDown)
                    RenderingDevice.SpriteBatch.Draw(keyboardTex, pos, temp, col, 0.0f, origin, 0.83f * RenderingDevice.TextureScaleFactor, SpriteEffects.None, 0);
                else if(scaleDown)
                    RenderingDevice.SpriteBatch.Draw(keyboardTex, pos, temp, col, 0.0f, origin, 0.444f * RenderingDevice.TextureScaleFactor, SpriteEffects.None, 0);
            }
        ...
        public static void WriteXboxIcon(Buttons button, Vector2 pos, Vector2 origin, bool scaleDown)
        {
            ...
            Color col = new Color(255, 255, 255, alpha) * (alpha / 255f);
            if(!scaleDown)
                RenderingDevice.SpriteBatch.Draw(xboxTex, pos, temp, col, 0.0f, origin, 0.83f * RenderingDevice.TextureScaleFactor, SpriteEffects.None, 0);
            if(scaleDown)
                RenderingDevice.SpriteBatch.Draw(xboxTex, pos, temp, col, 0.0f, origin, 0.444f * RenderingDevice.TextureScaleFactor, SpriteEffects.None, 0);
        }
