            ...
            for(int i = 0; i < formattedText.Length; i++)
            {
                if(formattedText[i] == printS)
                {
                    ...
                    if(Input.ControlScheme == ControlScheme.Keyboard)
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.SelectionKey,
                        ...
                        SymbolWriter.WriteXboxIcon(Input.XboxOptions.SelectionKey,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + spacesVector * 0.5f * RenderingDevice.TextureScaleFactor + upperLeft, color.A);
                ...
                else if(formattedText[i] == printCam)
                {
                    ...
                    {
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.CameraUpKey,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + upperLeft + replaceLR1 * RenderingDevice.TextureScaleFactor, color.A);
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.CameraLeftKey,
                        ...
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.CameraDownKey,
                        ...
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.CameraRightKey,
                ...
                else if(formattedText[i] == printNum1)
                {
                    previous = font().MeasureString(temp) * RenderingDevice.TextureScaleFactor * scale;
                    if(Input.ControlScheme == ControlScheme.XboxController)
                        SymbolWriter.WriteXboxIcon(Input.XboxOptions.Machine1Key,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + spacesVector * 0.5f * RenderingDevice.TextureScaleFactor + upperLeft, color.A);
                    else
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.Machine1Key,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + spacesVector * 0.5f * RenderingDevice.TextureScaleFactor + upperLeft, color.A);
                    formattedText[i] = spacesPerIcon;
                    temp += spacesPerIcon + " ";
                }
                else if(formattedText[i] == printTilde)
                {
                    previous = font().MeasureString(temp) * RenderingDevice.TextureScaleFactor * scale;
                    if(Input.ControlScheme == ControlScheme.XboxController)
                        SymbolWriter.WriteXboxIcon(Input.XboxOptions.QuickBoxKey,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + spacesVector * 0.5f * RenderingDevice.TextureScaleFactor + upperLeft, color.A);
                    else
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.QuickBoxKey,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + spacesVector * 0.5f * RenderingDevice.TextureScaleFactor + upperLeft, color.A);
                    formattedText[i] = spacesPerIcon;
                    temp += spacesPerIcon + " ";
                }
                ...
                else if(formattedText[i] == printZoom)
                {
                    ...
                    if(Input.ControlScheme == ControlScheme.Keyboard)
                    {
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.CameraZoomPlusKey,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + upperLeft + replaceLR1 * RenderingDevice.TextureScaleFactor, color.A);
                        SymbolWriter.WriteKeyboardIcon(Input.WindowsOptions.CameraZoomMinusKey,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + upperLeft + replaceLR2 * RenderingDevice.TextureScaleFactor, color.A);
                    }
                    else
                    {
                        SymbolWriter.WriteXboxIcon(Input.XboxOptions.CameraZoomPlusKey,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + upperLeft + replaceLR1 * RenderingDevice.TextureScaleFactor, color.A);
                        SymbolWriter.WriteXboxIcon(Input.XboxOptions.CameraZoomMinusKey,
                            new Vector2(previous.X, numNewlines * newlineHalfHeight) + upperLeft + replaceLR2 * RenderingDevice.TextureScaleFactor, color.A);
                    }
                    formattedText[i] = replaceLR;
                    temp += replaceLR + " ";
